...
public:
    ...
    PennChordMessage::PennChordPacket find_finger(NodeInfo originator, unsigned char location[], uint32_t transactionId_original);
    PennChordMessage::PennChordPacket reply_finger(NodeInfo finger, Ipv4Address requestee, NodeInfo originator, uint32_t transactionId_original);
